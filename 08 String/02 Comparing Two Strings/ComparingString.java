...
public class ComparingString {
   ...
   public static void main(String[] args) {
      ...
      // Create two strings with the same value, but one is a literal and the other is created using the 'new' keyword
      String name = "Mohit"; 
      ...
      if (name == sameName) {
         // This will print because both 'name' and 'sameName' refer to the same string literal in the string pool
